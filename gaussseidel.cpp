...
*	Fecha:	01/Nov/2014
*	Descripcion: Programa que resuelve un SEL utilizando el método iterativo de Gauss Seidel.
*/
#include<iostream>
#include<cstdlib>
#include<cmath>
...
int main(){
	...
	entrada>>n;
	if(n<0 || n>MAXN){
        cout<<"La dimension de la matriz es incorrecta n = (0,10]"<<endl;
        system("pause");
        return 0;
    }
	Matriz arreglo(n);
