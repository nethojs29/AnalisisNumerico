...
int main(){
    int n;
    long double an,bn,pn,fan,fbn,fpm,fpn,error,tol;

    cout<<"Programa para calcular la aproximaci\xa2n a la ra\xa1z de F(x)"<<endl;
    cout<<"F(x) = e^-x + 4x^3 - 5\n\n"<<endl;

    cout<<"Primer punto del invervalo: ";
    cin>>an;

    do{
        cout<<"Segundo punto del intervalo: ";
        cin>>bn;
        if(bn<an) cout<<"bn debe de ser mayor que an"<<endl;
    }while(bn<an);
